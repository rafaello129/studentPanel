// src/components/EvaluationDetails.tsx
...
const EvaluationDetails: React.FC = () => {
  ...
  return (
    <Box sx={{ p: 4 }}>
      ...
      {/* Crear Nueva Sección */}
      <CreateSectionComponent evaluationId={Number(evaluationId)} />
      ...
      {/* Renderizar el componente de actualización de sección fuera del Draggable */}
