...
interface Props {
    ...
    export const CreateSpSubjectModal: FC<Props> = ({ setShowModal}) => {
    ...
    const {
        ...
        getFieldProps } = useFormik({
            ...
            onSubmit: async (values) => {
                console.log(values)
                const res = await createSubject({name: values.name, clave: values.clave, specialty: true} );
                console.log(res);
                console.log(result);
                resetForm();
                setShowModal(false)
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Agregar Materia de Especialidad</h5>
                        <button
                            type="button"
